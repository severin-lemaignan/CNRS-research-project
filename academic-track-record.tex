...
\begin{shaded}%
% vertical text
%\hspace{-1.5cm}\rotatebox{90}{\hspace{-2cm}Paper~\autocite{#1}}
%{\noindent\bf Publication~\autocite{#1}}\\
\begin{tabular}{p{1.7cm}p{10cm}}%
    \vspace{-.20cm}\includegraphics[height=2.3cm]{thumbs/#2} & \vspace{0.1cm} #3 \\
    \multicolumn{2}{p{13cm}}{\vspace{0.1cm}#4\newline\emph{[Contribution: #5]}}%
\end{tabular}%
\end{shaded}
\end{leftbar}}
