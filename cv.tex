...
a human user was greatly simplified}, as I show in~\autocite{lemaignan2011grounding}
(see box below) and in eg~\autocite{ros2010robot}.
...
system~\autocite{lemaignan2017artificial} (see box below) is still \textbf{one of
...
\paper{2016-cowriter.jpg}{
    ...
    robot to significantly improve the children' self-confidence. A landmark
    contribution to social robotics for education.
}{
    principal investigator; 179 citations (incl. conf. article)
}
