...
\TODO{Add potential collaborations to each research strands, ANITI + non-ANITI}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inspired from word embeddings (eg.~\textcite{mikolov2013distributed}). If fruitful,
...
to achieve with the current state-of-art~\autocite{bartlett2019what}), and
...
In~\textcite{suguitan2020moveae}, a Generative Adversarial Network (GAN) is
...
ambitious experimental programme, itsefl underpinned by technical excellence.
...
for~\textcite{senft2019teaching} and~\textcite{winkle2020insitu}), and
...
However, one critical aspect of the technology that I want to investigate in
...
(Figure~\ref{fig:ros4hri}, \TODO{arxiv paper}), with preliminary steps in place
for multi-modal human modeling. I intend to continue this effort.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{pipeline}
    \caption{Overview of the 'ROS4HRI' framework\TODO{Add arxiv paper} that I originally designed, and
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{self-balancing-robots}
...
\begin{outcome}{5.1}
A asserted technical excellence, with continual contributions to the technical
state-of-the-art in social robots.

This commitment will be evidenced throught:
    \begin{itemize}
        \item continuous engagement and leadership within the open-source
            robotic community;
        \item creation and leadership of the `ROS4HRI' community, 
    \end{itemize}
