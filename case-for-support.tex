...
I present in this section the 4+1 main research strands that I intend to develop as
a CNRS research scientist. These research priorities are guided by the
scientific objectives listed in the previous section.
...
\begin{itemize}
    ...
    \item {\bf Strand 2} investigates the \textbf{intelligent generation of social
        behaviours}, exploring novel techniques like adversarial generative
        networks;
...
conducted at LAAS. Building on my extensive experience in real-world deployments
...
\subsection{Coherence of the research programme}
...
These five strands are tightly coupled (Figure~\ref{fig:wps}), and together,
will enable a major scientific and technical breakthrough in autonomous,
socially-intelligent, robots.

Figure~\ref{fig:wps} gives an overview of how the research directions interact
with each other. Fieldwork plays a central role in my research programme (item 4.3 in
the figure~\ref{fig:wps}), and
also appears in the centre of the figure. Indeed, the deployment of autonomous social
...
definition of core interaction principles. Using machine learning to learn from
these field experiments (3.2), these core principles are in turn translated into
algorithmic models, guiding the social teleology of the cognitive architecture
(3.1).

The regular fieldwork I intend to conduct will also provide the source of data
to feed into to Strand 1: Strand 1, focusing on \emph{social situation assessment},
researches, developes, and integratees all the components
...
\subsection{Technical ambition of the research programme}

My research project includes an ambitious, beyond-state-of-art, technical work
programme. Figure~\ref{fig:archi} offers an overview of the whole AI engine.
...
it with representations of the social dynamics around the robot. Strand 2
(bottom) significantly improve upon techniques for non-repetitive,
socially-congruent behaviour production, combining recent advances in generative
neural nets, art, and novel acoustic communication modalities. Strand 3 (centre)
integrates the robot cognitive capabilities in a new cognitive architecture for
long-term social autonomy. It introduces a novel arbitration mechanism between
action policies, to enable both long-term, goal-driven autonomous behaviours,
and direct in-situ learning from the robot's end-users, to ensure transparency
and human oversight.

\begin{figure}[h!]
\centering
\includegraphics[width=0.8\linewidth]{figs/archi}
\caption{Overview of the AI architecture at the core of the research programme.}
\label{fig:archi}
\end{figure}
...
\subsubsection{2.1 -- Hybrid situation assessment and knowledge representation}
...
\begin{framed}
    {\noindent\bf Main outcomes of 2.1:} an extensible multi-modal
...
\subsubsection{2.2 -- Multi-modal human model}
...
\begin{framed}
    {\noindent\bf Main outcome of 2.2:} A data-driven social signal processing
    pipeline to model the surrounding humans.
\end{framed}

\subsubsection{2.3 -- Interaction and group dynamics}
...
\begin{framed}
    {\noindent\bf Main outcome of 2.3:} the software pipeline required for the automatic analysis of social
    dynamics at group-level, able to model in real-time the social context
    of the robot.
\end{framed}


\subsubsection{2.4 -- Social situation assessment}

In 2.4, I integrate the social
cues from 2.2 and 2.3 into the representation platform developed in 2.1. It will
...
representation capabilities of implemented in 2.1 to the social sphere, and covers the
...
\begin{framed}
    {\noindent\bf Main outcome of 2.4:} a novel cognitive sub-system for social
    situation assessment, released as an open-source set of integrated ROS
    modules ("\emph{ROS4HRI}"). This set of tools will enable the robot to
...
\subsubsection{2.5 -- Social embeddings}
...
\begin{framed}
    {\noindent\bf Main outcome of 2.5:} the investigation of \emph{social
...
robotics~\parencite{lemaignan2015mutual} for this work.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Strand 3: \textbf{\wpThree}} 
...
Using activity switching to support long term engagement with diabetic children\parencite{coninx2016towards}
...
generation\parencite{yang2019appgan,marmpena2019generating,suguitan2020moveae}; (2) interactive
...
behaviours\parencite{senft2019teaching, winkle2020insitu} that fully involve the
end-users\parencite{winkle2018social}.

In\parencite{suguitan2020moveae}, a Generative Adversarial Network (GAN) is trained
...
(eg\parencite{greher2010soundscape}). The soundscapes that we will create, are
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Strand 4: \textbf{\wpFour}}
...
been successfully applied to relatively simple cognitive systems~\parencite{oudeyer2005playground,moulinfrier2014self}or virtual agents\parencite{pathak2017curiosity}. This task's objective is to define and implement a novel \emph{social teleology} that would
...
social learning\parencite{senft2019teaching,winkle2020insitu}, this task
...
developed with my students in\parencite{senft2017supervised}.
...
ACT-R/E\parencite{trafton2013act}, HAMMER\parencite{demiris2006hierarchical}, PEIS
Ecology\parencite{saffiotti2005peis,daoutis2012cooperative},
CRAM/KnowRob\parencite{beetz2010cram, tenorth2009knowrob},
KeJia\parencite{chen2010developing}, POETICON++\parencite{antunes2016from}, and my own,
the LAAS Architecture for Social Interaction\parencite{lemaignan2017artificial}):
...
underpinnings of human-robot interaction by taking a strong human-centered
perspective. I frame this as a shift from \emph{human-robot interaction} to
\emph{robot-supported human-human interactions} (r-HHI). This last major strand
of research operationalises this objective as two main tasks: a theoretical contribution, examining the interplay
between r-HHI, responsible AI, and ethics; and a large-scale study to gather
public input.

\textbf{4.1 -- Conceptual framing of r-HHI and ethical framework} 
...
\textbf{4.2 -- Crowd-sourced patterns of robot-supported social
...
for\parencite{senft2019teaching} and\parencite{winkle2020insitu}), and interviews of both the
...
My research project involves social robots, interacting in repeated ways and
...
children\parencite{lemaignan2016learning,lemaignan2018pinsoro,senft2019teaching}),
...
in\parencite{stilgoe2013developing} (and has been subsequently adopted by the UK Engineering
and Physical Sciences Research Council\parencite{owen2014uk}) using the acronym
...
framework\parencite{stahl2018implementing}~\footnote{\url{https://www.orbit-rri.org/about/area-4p-framework/}},
