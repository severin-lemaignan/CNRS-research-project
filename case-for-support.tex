...
\textbf{the development of fully autonomous social robots, able to
foster and maintain long-term interactions}. This aim is beyond the state of the
art, and while ambitious science is required to achieve it, \textbf{technical
excellence is a fundamental enabler}. I am excited about such a major
technical challenge, and following on from my strong technical track-record, I
will innovate to build and assemble the leading technology required to bring
...
grounding tool \texttt{dialogs}~\autocite{lemaignan2011grounding}, the HRI
simulator \texttt{morse}~\autocite{echeverria2011morse}, the 3D
situation assessment platform
\texttt{underworlds}~\autocite{lemaignan2018underworlds}, the LAAS architecture
for social interaction~\autocite{lemaignan2017artificial}, or novel algorithms
...
neighbouring fields. In particular, remarkable progress has been made over the past
...
real-world situations. While not an intrinsic weakness of machine
...
(Figure~\ref{fig:ros4hri}, \autocite[preprint]{mohamed2020ros}), with preliminary steps in place
...
More can be done, however, and as a CNRS researcher, I will commit to further
enhance the methodological excellence both within the laboratory, and within the
broader academic community -- to this end, I will leverage my editorial roles in
high-profile publications and conferences (most notably FrontiersIn Robotics and
AI, and the ACM/IEEE Human-Robot Interaction conference) to advance this agenda.
Specific actions include:

\begin{itemize}
    \item promoting \textbf{reproducible science} by always providing the code and data
        analysis scripts used in experiments;
    \item encouraging \textbf{pre-registered studies} where the exact methodology is
        published \emph{before} performing the study itself, ensuring the
        highest standard of experimental rigour;
    \item educate to \textbf{robust statistics}, including for instance Bayesian
        statistics;
