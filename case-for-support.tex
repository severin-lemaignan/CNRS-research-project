...
complex social
environments~\cite{senft2017supervised,senft2019teaching,winkle2020insitu}
...
autonomous. As I previsouly argued~\cite{senft2019teaching}, this approach
...
I present in this section the four main research strands that I intend to develop as
...
\begin{itemize}
    ...
    \item Finally, {\bf Strand 4} will both: build-up the \textbf{experimental
        capacity} of the LAAS-CNRS in HRI with large scale field deployments; and
        simultaneously co-construct with the general public and ethics expert
        the conceptual framework and concrete guideline for \textbf{responsible
...
These four strands are tightly coupled (Figure~\ref{fig:wps}), and together,
...
\subsection{Strand 1: \textbf{\wpOne}}
...
for\cite{senft2019teaching} and\cite{winkle2020insitu}), and interviews of both the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Strand 2: \textbf{\wpTwo}}
...
generation\cite{yang2019appgan,marmpena2019generating,suguitan2020moveae}; (2) interactive
...
behaviours\cite{senft2019teaching, winkle2020insitu} that fully involve the
...
been successfully applied to relatively simple cognitive systems~\cite{oudeyer2005playground,moulinfrier2014self}or virtual agents\cite{pathak2017curiosity}. This task's objective is to define and implement a novel \emph{social teleology} that would
...
social learning\cite{senft2019teaching,winkle2020insitu}, this task
...
%extending the state of the art\cite{lemaignan2017artificial}\textsuperscript{,}\cite{baxter2016cognitive}.
%
%\begin{framed}
...
%developed\cite{lemaignan2018underworlds}\cite{sallami2019simulation},
%drawing on recent
...
%model-based\cite{gunes2017automatic}\textsuperscript{,}\cite{lemaignan2016realtime} and
%data-driven\cite{bartlett2019what}. This task goes beyond the
...
%drawn from my previous work\cite{lemaignan2018pinsoro}, as well as from
%the project experiments (T1.2, T5.1, T5.2).
%
%\textbf{T2.3 -- Interaction and group dynamics} Building on T2.2, T2.3
%investigates the automatic understanding and modelling of group-level social
%interactions\cite{tapus2019perceiving}, including
%$f$-formations\cite{marshall2011using},
%sociograms\cite{garcia2016hybrid}, and inter-personal
%affordances\cite{pandey2013affordance}. This task builds on literature on
%social dynamics analysis
%(eg\cite{durantin2017social}\textsuperscript{,}\cite{jermann2009physical}\textsuperscript{,}\cite{martinez2019collocated})
...
%Happé\cite{frith1994autism}, which I introduce in\cite{lemaignan2015mutual}) to
...
%robot motion
%generation\cite{yang2019appgan}\textsuperscript{,}\cite{marmpena2019generating}\textsuperscript{,}\cite{suguitan2020moveae}
...
%with my students promising results for generating complex social
%behaviours\cite{senft2019teaching}\textsuperscript{,}\cite{winkle2020insitu}
%that fully involve the end-users\cite{winkle2018social}. Modulating (1)
...
%interventions\cite{greher2010soundscape}. The soundscapes that I will
...
%challenge in social robotics\cite{hoffman2019anki}, the WP adopts a very novel
...
%systems\cite{oudeyer2005playground}\textsuperscript{,}\cite{moulinfrier2014self})
%or virtual agents\cite{pathak2017curiosity}.This task will design and
...
%learning\cite{senft2017supervised}\textsuperscript{,}\cite{senft2019teaching}\textsuperscript{,}\cite{winkle2020insitu},
...
%architecture\cite{lemaignan2017artificial}, this task brings together, in
...
%schools\cite{leite2014empathic,westlund2017measuring,
%lemaignan2016learning,coninx2016towards}, homes\cite{degraaf2017phased} and
%care centres\cite{hawes2017strands,winkle2020insitu}) over relatively long
%periods of time (up to 2 or 3 months at a time). Even though these robots are
%typically not fully autonomous, they do exhibit a level of autonomy, either by
%handling autonomously a relatively broad range of shallow tasks (eg, a
%butler-like robot answering simple questions, like in\cite{hawes2017strands} or
%in the H2020 MuMMer\cite{heikkila2018can} and FP7
%Spencer\cite{triebel2016spencer} projects), or a narrow, well-specified complex
%task (for instance, supporting exercising in a gym, as I did in\cite{winkle2020insitu}).
%However, general purpose, long-term interaction is still an open question.
%
%
...
%environments\cite{senft2017supervised, senft2019teaching, winkle2020insitu} -- relies
...
%\textbf{Task 4.2} The techniques developed in T4.2 have been previously used and
%tested by the PI in two different real-world
%environments\cite{senft2019teaching,winkle2020insitu}. While they will require
%significant adjustments for this project, the task is overall \ul{\bf low-risk,
%low-gain}.
%
%\textbf{Task 4.3} The integration of the different cognitive functions of the
